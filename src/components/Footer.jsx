...
//           </a>
//           <p className='hidden lg:flex mt-20 text-neutral-400'>&copy; {new Date().getFullYear()} Mbstech.ai All rights reserved.</p>
//         </div>
//         <div className='grid md:grid-cols-3 text-start gap-10 px-10 max-w-6xl w-full'>
//         <div className='grid sm:grid-cols-2 md:grid-cols-1 md:gap-10'>
...
//         </div>
//         </div>
//         <p className='lg:hidden flex mt-20 text-neutral-400'>&copy; {new Date().getFullYear()} Mbstech.ai All rights reserved.</p>
//       </div>
//     </footer>
//   );
// };
